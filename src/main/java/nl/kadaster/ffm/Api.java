...
public class Api {
    ...
    Api() throws Exception {
        ...
        context = Linker.nativeLinker().downcallHandle(symbolLookup.find("proj_context_create")
        ...
        pj = Linker.nativeLinker()
                .downcallHandle(symbolLookup.find("proj_create_crs_to_crs")
        ...
        transform = Linker.nativeLinker().downcallHandle(symbolLookup.find("proj_trans")
