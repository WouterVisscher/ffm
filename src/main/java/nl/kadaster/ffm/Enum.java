...
public class Enum {
  ...
  public static void main(String[] args) throws Throwable {
    ...
    final var getenumSymbol =
        symbolLookup.find("getenum").orElseThrow(() -> new Exception("Could not find getenum"));
    ...
    final var setenumSymbol =
        symbolLookup.find("setenum").orElseThrow(() -> new Exception("Could not find setenum"));
