...
public class Proj {
    public static void main(String[] args) throws Throwable {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            // var pj_ctx = ((MemorySegment) DataTypes.pj_context.get(pj)).reinterpret(DataTypes.PJ_CONTEXT.byteSize());
            // var short_name = ((MemorySegment) DataTypes.short_name.get(pj));
            // short_name = short_name.reinterpret(MemoryLayout.sequenceLayout(128, JAVA_BYTE).byteSize());
