...
public class Projversion {
        ...
        public static void main(String[] args) throws Throwable {
                ...
                final var proj_create_crs_to_crsSig = FunctionDescriptor.of(ADDRESS, ADDRESS, ADDRESS, ADDRESS,
                                ADDRESS);
                ...
                try (Arena arena = Arena.ofConfined()) {
                        ...
                        MemorySegment ms_proj_trans = (MemorySegment) proj_trans.invoke(ms_proj_create_crs_to_crs, fwd,
                        r_ms_proj_coord);
